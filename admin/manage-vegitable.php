...
<table class="table table-responsive">
    ...
    <tr>
        <?php
            $qry="select v_id,v_name,available,v_qty from veg_sell";
        ...
        <td><?php echo $r[2]; ?></td>
        <td><?php echo $r[3]; ?></td>
        <td><a href="edit_vegetable_by_link.php?q=<?php echo $r[0]; ?>">Edit</td>
        <td><a href="delete_vegetable_by_link.php?q=<?php echo $r[0]; ?>">Delete</td>
