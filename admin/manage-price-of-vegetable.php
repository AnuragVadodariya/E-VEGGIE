...
<table class="table table-responsive">
    ...
    <tr>
        <?php
            $qry="select v_id,v_name,pr_250gm,pr_500gm,pr_1kg from veg_sell";
        ...
        <td><?php echo $r[3]; ?></td>
        <td><?php echo $r[4]; ?></td>
        <td><a href="edit_price_by_link.php?w=<?php echo $r[0]; ?>">Edit</td>
        <td><a href="delete_price_by_link.php?w=<?php echo $r[0]; ?>">Delete</td>
